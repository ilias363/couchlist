      ...
      <main className="container mx-auto px-6 py-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Keep track of your favorite movies and TV shows, discover new content, and analyze your
            viewing habits all in one place.
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Keep track of movies you&apos;ve watched and want to watch, and build your personal
                collection.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Track your progress through TV series, mark episodes as watched, and never lose your
                place again.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription>
                Discover new movies and shows based on your preferences and what&apos;s trending in
                the community.
              </CardDescription>
            </CardContent>
          </Card>
