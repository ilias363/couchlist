  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        {/* Primary spotlight */}
        <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-7xl h-200 bg-gradient-radial from-primary/15 via-primary/5 to-transparent rounded-full blur-3xl opacity-60" />
        {/* Secondary accent glow */}
        <div className="absolute bottom-[-10%] right-[-10%] w-160 h-160 bg-gradient-radial from-primary/10 to-transparent rounded-full blur-3xl" />
        {/* Ambient left glow */}
        <div className="absolute top-1/2 left-[-10%] w-[24rem] h-200 bg-gradient-radial from-primary/8 to-transparent rounded-full blur-3xl opacity-40" />
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16 sm:pb-28 relative">
        <div className="max-w-4xl mx-auto text-center space-y-8 sm:space-y-10">
          ...
          >
            Never lose track of your favorite movies and TV shows. Build your
            personal library, track your progress, and discover what to watch
            next.
          </p>
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-muted-foreground text-sm sm:text-lg max-w-2xl mx-auto px-2">
            Powerful features designed to make tracking your entertainment
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="max-w-4xl mx-auto text-center glass-card rounded-2xl sm:rounded-3xl p-8 sm:p-12 md:p-16 relative overflow-hidden border-gradient">
          ...
          <p className="text-muted-foreground text-sm sm:text-lg mb-8 sm:mb-10 max-w-xl mx-auto">
            Join CouchList today and take control of your entertainment journey.
